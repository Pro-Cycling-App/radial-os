/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 52600087decd006d2b7457b3c1e0ce43)
...
interface __BaseEnv_Env {
	...
	NEON_PROJECT_ID: "replace-me";
	DATABASE_URL: string;
	NEON_API_KEY: string;
	RADIAL_OS_DATABASE_PASSWORD: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CUSTOM_NAME" | "CUSTOM_MESSAGE" | "NEON_PROJECT_ID" | "DATABASE_URL" | "NEON_API_KEY" | "RADIAL_OS_DATABASE_PASSWORD">> {}
}
